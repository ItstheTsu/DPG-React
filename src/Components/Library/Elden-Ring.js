...
import imgConq1 from "../../Images/Assets/conquistas/elden.jpg";
import imgConq2 from "../../Images/Assets/conquistas/elden1.png";
import imgConq3 from "../../Images/Assets/conquistas/elden2.png";
        ...
        <div className={styles.libraryTop}>
          <div className={styles.gameInfo}>
            <div className={styles.logo}>
              <img src={logoElden} alt="img" />
            </div>
            <div className={styles.nameDateConq}>
              <div className={styles.nameDate}>
                <div className={styles.name}>Elden Ring</div>
          ...
          <div className={styles.dashboardLibrary}>
            <Link to="/Library/Fifa-23">
              <a href="/#" className={styles.item}>''
                <div className={styles.logo}>
                  <img src={logoFifa} className={styles.BGgame} alt="img" />
                </div>
              </a>
            </Link>
